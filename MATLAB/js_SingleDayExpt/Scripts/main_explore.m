...
% except for ZT2 which has 64. Some animals have an extra 2 epochs, but
% Justin said to just ignore those when doing my analyses. He didn't
% include epoch 18 or 19 in his analyses.
...
% 
% All the EEG traces are flipped from the actual recorded EEG.
% 
...
% sleep - start and end times of sleep.
...
% Note linfields seems to have 1 less epoch than other files, as it doesn't
% bother putting in an empty cell for the last sleep epoch.
...
% this data, including: time, linear velocity(in 3 columns, Justin says use velocity
% found in pos file instead), linear distance,
% trajectory, ...
%
% pos:
% day / epoch
% Contains under field 'data': time, x position, y position, direction, and
% velocity. This is the velocity I should use for thresholding behavior
% epochs.
